...
<body class="font-poppins text-[#0A090B]">
    <section id="signup" class="flex w-full min-h-[832px]">
        ...
        {{-- <div class="m-[30px] left-side min-h-screen flex flex-col w-full pb-[30px] pt-[82px]">
        ...
        <button type="submit"
            class="md:w-full w-2/3 h-[52px] p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Sign
        ...
        <div class="m-[30px] left-side min-h-screen flex flex-col w-full pb-[30px] pt-[82px]">
            <div class="h-full w-full flex items-center justify-center">
                <form method="POST" action="{{ route('login') }}"
                    class="flex flex-col gap-[30px] w-full max-w-[450px] sm:w-11/12 md:w-[450px] shrink-0">
                    @csrf
                    <h1 class="font-bold text-2xl leading-9">Sign In</h1>
                    <div class="flex flex-col gap-2">
                        <p class="font-semibold">Email Address</p>
        ...
        <div class="flex flex-col gap-2">
            ...
            <div
                ...
                <input type="password" id="password"
                    class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                    placeholder="Write your correct input here" name="password">
                <button type="button" id="togglePassword" class="ml-2 w-6 h-6 flex items-center justify-center">
                    <img src="{{ asset('/images/icons/eye-closed-com.svg') }}" class="h-full w-full object-contain"
                        alt="Show/Hide Password">
                </button>
            </div>
        </div>
        <button type="submit"
            class="w-full h-[52px] p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] mx-auto text-center">
        ...
        <div
            class="right-side min-h-screen hidden md:flex flex-col w-[650px] shrink-0 pb-[30px] pt-[82px] bg-[#6436F1]">
...
<script>
    ...
    togglePassword.addEventListener('click', function () {
        ...
        this.querySelector('img').src = type === 'password' ? "{{ asset('/images/icons/eye-closed-com.svg') }}" :
            "{{asset('/images/icons/eye-open-com.svg')}}";
    });
