        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <a href="{{route('dashboard.courses.show', $course->id)}}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Manage Courses</a>
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
            ...
            <form method="POST" action="{{route('dashboard.course.course_student.store', $course)}}"" id="add-student" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
